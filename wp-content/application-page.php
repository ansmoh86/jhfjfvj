...
<form method="post" action="https://evisa-esta.us.com/review/" name="application" id="application">
  <div class="form-row">
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="wusaddress1" data-validate="required" required>
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="wusaptnumber" data-validate="required">
    </div>
</div> 
...
<div class="form-row">
    <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="wuscity" data-validate="required" required>
    </div>
    <div class="form-group col-md-4">
