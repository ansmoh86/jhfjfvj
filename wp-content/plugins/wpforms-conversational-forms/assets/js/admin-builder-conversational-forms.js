...
var WPFormsBuilderConversationalForms = window.WPFormsBuilderConversationalForms || ( function( document, window, $ ) {
	...
	var app = {
		 ...
		 * @param {bool} immediate Run immediate or no.
		 *
		...
		ready: function() {
			...
			document.getElementById( 'wpforms-panel-field-settings-conversational_forms_color-input' ).addEventListener(
				'input',
				app.debounce(
					function( value ) {
						$( '#wpforms-panel-field-settings-conversational_forms_color_scheme-7' ).minicolors( 'value', value.target.value );
					},
					750
				)
			);
		...
		colorPickerEvents: function() {
			...
			$( '#wpforms-panel-field-settings-conversational_forms_color_scheme-7' ).minicolors( {
				...
				change: function( value ) {
					...
					document.getElementById( 'wpforms-panel-field-settings-conversational_forms_color-input' ).value = value;
				},
			} );
		},
