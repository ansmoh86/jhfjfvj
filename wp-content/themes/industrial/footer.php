		...
		<div class="port">
			<div class="boldRow">
				...
				<div class="rowItem btFooterMenu col-md-6 col-sm-12 <?php echo esc_attr( BoldThemesFramework::$right_alignment_class ) ?>">
				   <!-- /copy <ul id="menu-menu1" class="menu1" style="float:right;"><li class="menu-item">
				    <div data-id="cff626ddd3" class="livechat_button"><a href="https://www.livechatinc.com/customer-service/?utm_source=chat_button&utm_medium=referral&utm_campaign=lc_11482953">Contact</a></div> -->
				    </li></ul> 
